...
from sisl import AbstractMAEnv, Agent

# from rltools.util import EzPickle
from sisl.utils import EzPickle
...
class MultiWalkerEnv(AbstractMAEnv, EzPickle):
    ...
    def step(self, actions):
        ...
        rewards_prey = rewards
        rewards_team = rewards[0]

        return obs, rewards, rewards_prey, team_reward, [done] * self.n_walkers, info_n
